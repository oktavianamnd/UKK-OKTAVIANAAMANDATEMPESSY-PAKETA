        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <div class="app-brand demo ">
                <a href="index.html" class="app-brand-link">
                    ...
                    <span class="app-brand-text demo menu-text fw-bolder ms-2">PEKAT</span>
                </a>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ Route::is('admin.masyarakat.index') ? 'active' : '' }}">
                ...
                @if (Auth::guard('petugas')->user()->level == 'admin')
                    <li class="menu-item {{ Route::is('admin.petugas.index') ? 'active' : '' }}">
                ...
                @endif
                <li class="menu-item {{ Route::is('admin.pengaduan.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.pengaduan.index') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Pengaduan</div>
                    </a>
                </li>
                <li class="menu-item {{ Route::is('admin.tanggapan.index') ? 'active' : '' }}">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small class="text-muted"> Adminnn </small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
