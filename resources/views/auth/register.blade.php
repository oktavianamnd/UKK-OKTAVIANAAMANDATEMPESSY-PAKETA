      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
              ...
              <span class="app-brand-text demo text-body fw-bolder">Register Masyarakat</span>
            </a>
        </div>
          <form id="formAuthentication" class="mb-3" action="{{route('register.store')}}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Enter your name" autofocus>
              </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="telp" name="telp" placeholder="Enter your telepon" autofocus>
              </div>
